...
const About  = () =>
    ...
    <Breadcrumb page={'About'}/>
      ...
      <section className='about-section-1 position-relative'>

        <header className='position-relative'>
          <div className='container'>
            <h2 className="about-header">About Our Store</h2>
          </div>
        </header>
      ...
      <section className='about-section-2 position-relative pb-5'>
        <div className="about-info container">
          <div className="text-weight-bold">
            <div className='row'>
              <div className='col-12 col-md-6'>
